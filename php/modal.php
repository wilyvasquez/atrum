    ...
    <section id="portfolio">
        <div class="container">
            ...
            <ul class="portfolio-filter text-center">
                <li><a class="btn btn-default active" href="#" data-filter=".ciudad">SCOOTER</a></li>
            ...
            <div class="row">
                <div class="portfolio-items">
                    <?php 
                        ...
                        $res='CIUDAD';
                        $consulta = "SELECT * FROM moto WHERE tipo_moto='CIUDAD'";
                    ...
                    $id = $datos['id_moto'];
                    ?>
                    <div class="portfolio-item ciudad col-xs-12 col-sm-4 col-md-3">
                        <div class="recent-work-wrap">
                            ...
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    ...
                                    <button type="button" onclick="openModal()" class="btn btn-danger" aria-label="Left Align" data-target=".bs-example-modal-lg">Detalles 
